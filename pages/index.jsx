    ...
    <nav style={{
      ...
      <div style={{ maxWidth:'1280px', margin:'0 auto', padding:'0 32px', height:'68px', display:'flex', alignItems:'center', justifyContent:'space-between' }}>
        ...
        <div className="d-nav" style={{ display:'flex', gap:'32px', alignItems:'center' }}>
          ...
          <Btn href="https://www.youtube.com/watch?v=h_JVTDhF6RY" external>▶ Watch Trailer Here</Btn>
        </div>
...
function AwardsSection() {
  return (
    <section id="awards" style={{ padding:'120px 24px', background:`linear-gradient(180deg, ${T.black} 0%, ${T.navyDark} 100%)`, position:'relative' }}>
...
function ImpactSection() {
  return (
    <section id="impact" style={{ padding:'120px 24px', background:`linear-gradient(180deg, ${T.navyDark} 0%, ${T.black} 100%)`, position:'relative' }}>
    ...
    <section id="watch" style={{ padding:'120px 24px', background:T.black }}>
      <div style={{ maxWidth:'1000px', margin:'0 auto' }}>
        <FadeUp>
          ...
          <SectionTitle>Watch the Trailer Here</SectionTitle>
      ...
      <div style={{ maxWidth:'700px', margin:'0 auto', position:'relative' }}>
        <FadeUp>
          ...
          <div style={{ display:'flex', gap:'14px', justifyContent:'center', flexWrap:'wrap' }}>
            ...
            <Btn href="https://www.youtube.com/watch?v=h_JVTDhF6RY" external primary={false}>▶ Watch Trailer Here</Btn>
          </div>
